...
namespace Alura.LeilaoOnline.Core
{
    ...
    public class Leilao
    {
        ...
        public void TerminaPregao()
        {
            ...
            {
                throw new System.InvalidOperationException($"Não foi possível terminar o pregão com status diferente de {nameof(EstadoLeilao.LeilaoEmAndamento)}");
            }

            Ganhador = _modalidade.ObtemGanhador(Lances);
